...
public class UserItem extends javax.swing.JPanel {
    ...
    public UserItem(UserBean user) {
        ...
        if(user.sex != null){
            this.sex.setText(user.sex.equalsIgnoreCase("M") ? "ƒ–" : "≈Æ");
        }else{
            this.sex.setText("");
        }
        this.age.setText(user.age+"ÀÍ");
        this.height.setText("…Ì∏ﬂ£∫"+TransferUtil.null2String(user.height));
        this.weight.setText("ÃÂ÷ÿ£∫"+TransferUtil.null2String(user.weight));
        this.bust.setText("–ÿŒß£∫"+TransferUtil.null2String(user.bust));
        this.waist.setText("—¸Œß£∫"+TransferUtil.null2String(user.waist));
        this.hip.setText("ÕŒŒß£∫"+TransferUtil.null2String(user.hip));
    ...
    private void initComponents() {
        ...
        userName.setFont(new java.awt.Font("ÀŒÃÂ", 0, 14)); // NOI18N
        userName.setText("userName");
        userName.setPreferredSize(new java.awt.Dimension(50, 30));
        jPanel2.add(userName);

        sex.setFont(new java.awt.Font("ÀŒÃÂ", 0, 14)); // NOI18N
        sex.setText("sex");
        sex.setPreferredSize(new java.awt.Dimension(50, 30));
        jPanel2.add(sex);

        age.setFont(new java.awt.Font("ÀŒÃÂ", 0, 14)); // NOI18N
        age.setText("age");

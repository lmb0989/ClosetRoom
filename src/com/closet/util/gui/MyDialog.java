...
public class MyDialog extends JDialog {
    ...
    private Dimension size = new Dimension(180, 70);

    // the option window that won't auto close constructor
    public MyDialog(boolean doNotAutoClose, JFrame parentJFrame, String message) {
    ...
    public MyDialog(JFrame parentJFrame, String message) {
        super(parentJFrame);
        this.setUndecorated(true);
        setSize(size);
        if (parentJFrame != null) {
    ...
    private class UndergroundPanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            GradientPaint gradient = new GradientPaint(0.0f, 0.0f, new Color(
                    250, 250, 250, 230), 0.0f, (float) height, new Color(250,
                            230, 230, 230));
...
//            g2.drawRoundRect(0, 0, width - 2, height - 2, 26, 26);
    ...
    private class MouseInputAdaptert extends MouseInputAdapter {
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            MyDialog.this.setLocation(MyDialog.this.getLocationOnScreen().x
                    + tempScreen.x - oldCursorPosition.x,
                    MyDialog.this.getLocationOnScreen().y + tempScreen.y
                    - oldCursorPosition.y);
...
//        MyJDialog test = new MyJDialog(MyJDialog.noAutoClose, null, "ddddddddd");
        MyDialog test2 = new MyDialog(null, "成功");
